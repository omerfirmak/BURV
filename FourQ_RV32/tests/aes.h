...
static inline void toBlock(uint8_t*data) { }
static inline void toBlockLow(uint64_t low_u64)        { }
static inline void toBlockBoth(uint64_t high_u64, uint64_t low_u64) { }
