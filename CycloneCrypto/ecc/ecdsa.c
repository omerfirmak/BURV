...
_error_t ecdsaWriteSignature(const EcdsaSignature *signature, uint8_t *data,
   size_t *length)
{
   _error_t error;
   size_t k;
...
_error_t ecdsaReadSignature(const uint8_t *data, size_t length,
...
_error_t ecdsaGenerateKeyPair(const EcDomainParameters *params,
...
__weak _error_t ecdsaGenerateSignature(const EcDomainParameters *params,
...
__weak _error_t ecdsaVerifySignature(const EcDomainParameters *params,
