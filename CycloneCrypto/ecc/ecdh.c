...
_error_t ecdhGenerateKeyPair(EcdhContext *context,
...
_error_t ecdhCheckPublicKey(const EcDomainParameters *params, EcPoint *publicKey)
{
   bool_t valid;
...
_error_t ecdhComputeSharedSecret(EcdhContext *context,
