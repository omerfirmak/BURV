...
_error_t ecLoadDomainParameters(EcDomainParameters *params,
...
_error_t ecCopy(EcPoint *r, const EcPoint *s)
{
   _error_t error;
...
_error_t ecImport(const EcDomainParameters *params, EcPoint *r,
...
_error_t ecExport(const EcDomainParameters *params, const EcPoint *a,
...
_error_t ecProjectify(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   _error_t error;
...
__weak _error_t ecAffinify(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   _error_t error;
   Mpi a;
...
_error_t ecDouble(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   _error_t error;
   Mpi t1;
...
_error_t ecAdd(const EcDomainParameters *params, EcPoint *r,
...
_error_t ecFullAdd(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s, const EcPoint *t)
{
   _error_t error;
...
_error_t ecFullSub(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s, const EcPoint *t)
{
   _error_t error;
   EcPoint u;
...
__weak _error_t ecMult(const EcDomainParameters *params, EcPoint *r, const Mpi *d,
   const EcPoint *s)
{
   _error_t error;
   uint_t i;
...
_error_t ecTwinMult(const EcDomainParameters *params, EcPoint *r,
...
_error_t ecAddMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   _error_t error;
...
_error_t ecSubMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   _error_t error;
...
_error_t ecMulMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   _error_t error;
...
_error_t ecSqrMod(const EcDomainParameters *params, Mpi *r, const Mpi *a)
{
   _error_t error;
