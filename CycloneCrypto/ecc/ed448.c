...
_error_t ed448GenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
_error_t ed448GenerateSignature(const uint8_t *privateKey,
...
_error_t ed448VerifySignature(const uint8_t *publicKey, const void *message,
