 ...
 * @param[in] b An integer such as 0 <= B < p
 **/
uint32_t _r[8] = {1444, 0, 0, 0, 0, 0, 0, 0};
uint32_t one[8] = {1, 0, 0, 0, 0, 0, 0, 0};
uint32_t n[8] = {0xffffffed, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0x7fffffff};
