...
_error_t xtsInit(XtsContext *context, const CipherAlgo *cipherAlgo,
...
_error_t xtsEncrypt(XtsContext *context, const uint8_t *i, const uint8_t *p,
...
_error_t xtsDecrypt(XtsContext *context, const uint8_t *i, const uint8_t *c,
