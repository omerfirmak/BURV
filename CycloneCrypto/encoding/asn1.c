...
_error_t asn1ReadTag(const uint8_t *data, size_t length, Asn1Tag *tag)
{
   uint_t i;
   uint_t n;
...
_error_t asn1ReadSequence(const uint8_t *data, size_t length, Asn1Tag *tag)
{
   _error_t error;
...
_error_t asn1ReadInt32(const uint8_t *data, size_t length, Asn1Tag *tag, int32_t *value)
{
   _error_t error;
   size_t i;
...
_error_t asn1WriteTag(Asn1Tag *tag, bool_t reverse, uint8_t *data, size_t *written)
{
   size_t i;
   size_t m;
   size_t n;
...
_error_t asn1WriteInt32(int32_t value, bool_t reverse, uint8_t *data, size_t *written)
{
   size_t i;
   size_t n;
   uint16_t msb;
...
_error_t asn1CheckTag(const Asn1Tag *tag, bool_t constructed, uint_t objClass, uint_t objType)
{
   //Check encoding
...
_error_t asn1CheckOid(const Asn1Tag *tag, const uint8_t *oid, size_t length)
{
   _error_t error;
...
_error_t asn1DumpObject(const uint8_t *data, size_t length, uint_t level)
{
