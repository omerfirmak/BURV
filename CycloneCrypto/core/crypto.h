...
typedef _error_t (*HashAlgoCompute)(const void *data, size_t length, uint8_t *digest);
...
typedef _error_t (*CipherAlgoInit)(void *context, const uint8_t *key, size_t keyLen);
...
typedef _error_t (*PrngAlgoInit)(void *context);
typedef void (*PrngAlgoRelease)(void *context);
typedef _error_t (*PrngAlgoSeed)(void *context, const uint8_t *input, size_t length);
typedef _error_t (*PrngAlgoAddEntropy)(void *context, uint_t source, const uint8_t *input, size_t length, size_t entropy);
typedef _error_t (*PrngAlgoRead)(void *context, uint8_t *output, size_t length);
