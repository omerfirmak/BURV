...
_error_t yarrowInit(YarrowContext *context);
void yarrowRelease(YarrowContext *context);

_error_t yarrowSeed(YarrowContext *context, const uint8_t *input, size_t length);

_error_t yarrowAddEntropy(YarrowContext *context, uint_t source,
   const uint8_t *input, size_t length, size_t entropy);

_error_t yarrowRead(YarrowContext *context, uint8_t *output, size_t length);
