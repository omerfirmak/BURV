...
_error_t mpiMod2(Mpi *r, const Mpi *a, const Mpi *p)
{
   _error_t error;
   size_t n;
   size_t modLen;
...
_error_t ecAffinify(const EcDomainParameters *ecParams, EcPoint *r,
   const EcPoint *s)
{
   _error_t error;
   size_t modLen;
...
_error_t ecMult(const EcDomainParameters *ecParams, EcPoint *r, const Mpi *d,
   const EcPoint *s)
{
   _error_t error;
   size_t kLen;
...
_error_t ecdsaGenerateSignature(const EcDomainParameters *ecParams,
...
_error_t ecdsaVerifySignature(const EcDomainParameters *ecParams,
