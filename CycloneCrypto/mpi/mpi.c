...
_error_t mpiGrow(Mpi *r, uint_t size)
{
   uint_t *data;
...
_error_t mpiSetBitValue(Mpi *r, uint_t index, uint_t value)
{
   _error_t error;
   uint_t n1;
   uint_t n2;
...
_error_t mpiCopy(Mpi *r, const Mpi *a)
{
   _error_t error;
   uint_t n;
...
_error_t mpiSetValue(Mpi *r, int_t a)
{
   _error_t error;
...
_error_t mpiRand(Mpi *r, uint_t length, const PrngAlgo *prngAlgo, void *prngContext)
{
   _error_t error;
   uint_t m;
   uint_t n;
...
_error_t mpiImport(Mpi *r, const uint8_t *data, uint_t length, MpiFormat format)
{
   _error_t error;
   uint_t i;
...
_error_t mpiExport(const Mpi *a, uint8_t *data, uint_t length, MpiFormat format)
{
   uint_t i;
   uint_t n;
   _error_t error;
...
_error_t mpiAdd(Mpi *r, const Mpi *a, const Mpi *b)
{
   _error_t error;
   int_t sign;
...
_error_t mpiAddInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
_error_t mpiSub(Mpi *r, const Mpi *a, const Mpi *b)
{
   _error_t error;
   int_t sign;
...
_error_t mpiSubInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
_error_t mpiAddAbs(Mpi *r, const Mpi *a, const Mpi *b)
{
   _error_t error;
   uint_t i;
   uint_t n;
...
_error_t mpiSubAbs(Mpi *r, const Mpi *a, const Mpi *b)
{
   _error_t error;
   uint_t c;
   uint_t d;
...
_error_t mpiShiftLeft(Mpi *r, uint_t n)
{
   _error_t error;
   uint_t i;
...
_error_t mpiShiftRight(Mpi *r, uint_t n)
{
   uint_t i;
   uint_t m;
...
__weak _error_t mpiMul(Mpi *r, const Mpi *a, const Mpi *b)
{
   _error_t error;
   int_t i;
   int_t m;
...
_error_t mpiMulInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
_error_t mpiDiv(Mpi *q, Mpi *r, const Mpi *a, const Mpi *b)
{
   _error_t error;
   uint_t m;
   uint_t n;
...
_error_t mpiDivInt(Mpi *q, Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
_error_t mpiMod(Mpi *r, const Mpi *a, const Mpi *p)
{
   _error_t error;
   int_t sign;
   uint_t m;
...
_error_t mpiAddMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   _error_t error;
...
_error_t mpiSubMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   _error_t error;
...
_error_t mpiMulMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   _error_t error;
...
__weak _error_t mpiInvMod(Mpi *r, const Mpi *a, const Mpi *p)
{
   _error_t error;
   Mpi b;
   Mpi c;
...
__weak _error_t mpiExpMod(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   _error_t error;
   int_t i;
   int_t j;
...
_error_t mpiMontgomeryMul(Mpi *r, const Mpi *a, const Mpi *b, uint_t k,
   const Mpi *p, Mpi *t)
{
   _error_t error;
   uint_t i;
...
_error_t mpiMontgomeryRed(Mpi *r, const Mpi *a, uint_t k, const Mpi *p, Mpi *t)
{
   uint_t value;
   Mpi b;
