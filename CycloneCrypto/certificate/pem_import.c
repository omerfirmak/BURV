...
_error_t pemImportDhParameters(const char_t *input, size_t length, DhParameters *params)
{
...
_error_t pemImportRsaPublicKey(const char_t *input, size_t length, RsaPublicKey *key)
{
...
_error_t pemImportRsaPrivateKey(const char_t *input, size_t length, RsaPrivateKey *key)
{
#if (RSA_SUPPORT == ENABLED)
   _error_t error;
   bool_t pkcs8Format;
...
_error_t pemImportDsaPrivateKey(const char_t *input, size_t length, DsaPrivateKey *key)
{
...
_error_t pemImportEcParameters(const char_t *input, size_t length, EcDomainParameters *params)
{
...
_error_t pemImportEcPrivateKey(const char_t *input, size_t length, Mpi *key)
{
#if (EC_SUPPORT == ENABLED)
   _error_t error;
   bool_t pkcs8Format;
...
_error_t pemImportEddsaPrivateKey(const char_t *input, size_t length, EddsaPrivateKey *key)
{
...
_error_t pemImportCertificate(const char_t **input, size_t *inputLen,
