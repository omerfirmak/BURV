...
_error_t dhGenerateKeyPair(DhContext *context,
...
_error_t dhCheckPublicKey(DhParameters *params, const Mpi *publicKey)
{
   _error_t error;
   Mpi a;
...
_error_t dhComputeSharedSecret(DhContext *context,
