...
_error_t rsaesPkcs1v15Encrypt(const PrngAlgo *prngAlgo, void *prngContext,
...
_error_t rsaesPkcs1v15Decrypt(const RsaPrivateKey *key, const uint8_t *ciphertext,
   size_t ciphertextLen, uint8_t *message, size_t messageSize, size_t *messageLen)
{
   ...
   do
   {
      ...
      *messageLen = CRYPTO_SELECT_32(n, messageSize, badLength);
      ...
      error = (_error_t) CRYPTO_SELECT_32(error, ERROR_BUFFER_OVERFLOW, badLength);
      error = (_error_t) CRYPTO_SELECT_32(error, ERROR_DECRYPTION_FAILED, badPadding);
...
_error_t rsaesOaepEncrypt(const PrngAlgo *prngAlgo, void *prngContext,
...
_error_t rsaesOaepDecrypt(const RsaPrivateKey *key, const HashAlgo *hash,
...
_error_t rsassaPkcs1v15Sign(const RsaPrivateKey *key, const HashAlgo *hash,
...
_error_t rsassaPkcs1v15Verify(const RsaPublicKey *key, const HashAlgo *hash,
...
_error_t rsassaPssSign(const PrngAlgo *prngAlgo, void *prngContext,
...
_error_t rsassaPssVerify(const RsaPublicKey *key, const HashAlgo *hash,
...
_error_t rsaep(const RsaPublicKey *key, const Mpi *m, Mpi *c)
{
...
__weak _error_t rsadp(const RsaPrivateKey *key, const Mpi *c, Mpi *m)
{
   _error_t error;
   Mpi m1;
   Mpi m2;
...
_error_t rsasp1(const RsaPrivateKey *key, const Mpi *m, Mpi *s)
{
...
_error_t rsavp1(const RsaPublicKey *key, const Mpi *s, Mpi *m)
{
...
_error_t emePkcs1v15Encode(const PrngAlgo *prngAlgo, void *prngContext,
...
_error_t emeOaepEncode(const PrngAlgo *prngAlgo, void *prngContext,
...
_error_t emsaPkcs1v15Encode(const HashAlgo *hash,
...
_error_t emsaPkcs1v15Verify(const HashAlgo *hash, const uint8_t *digest,
...
_error_t emsaPssEncode(const PrngAlgo *prngAlgo, void *prngContext,
...
_error_t emsaPssVerify(const HashAlgo *hash, size_t saltLen,
